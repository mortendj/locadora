...
from demo.people.guilherme_marques    import data as _tenant
from demo.people.eduardo_prado        import data as _guarantor
from demo.properties.tucanos_175_apto2 import data as _property
